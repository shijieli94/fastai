...
class ModelResetter(Callback):
    ...
    _docs = dict(
        before_train="Reset the model before training",
...
class RNNCallback(Callback):
    ...
    def after_pred(self):
        self.learn.pred, self.raw_out, self.out = [
            o[-1] if is_listy(o) else o for o in self.pred
        ]
...
def rnn_cbs(alpha=0.0, beta=0.0):
