...
def emb_sz_rule(n_cat: int) -> int:  # Cardinality of a category
...
class TabularModel(Module):
    ...
    def __init__(
        ...
        ps: float
        | MutableSequence = None,  # Sequence of dropout probabilities for `LinBnDrop`
        ...
        _layers = [
            ...
            for i, (p, a) in enumerate(zip(ps + [0.0], actns))
        ]
